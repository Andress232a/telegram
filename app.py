...
def get_video(video_id):
    ...
    try:
        ...
        if not phone:
            return jsonify({
                'error': 'No se pudo acceder al video. Por favor, inicia sesión o verifica la configuración del servidor.',
                'error_type': 'NoConfig',
                'video_id': video_id,
                'suggestion': 'Inicia sesión en la aplicación o verifica que el servidor esté configurado correctamente.'
            }), 401
